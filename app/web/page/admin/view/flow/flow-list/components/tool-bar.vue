<template>
  <div class="left_top" @click="toolbarClick">
    <svg
      ...
      <text x="30" y="20" fill="black">图形示例</text>
      <g id="line-up" draggable="true" @dragstart="dragStart($event, 'line-up')" @click="select('line-up')">
        <path class="wrapper" d="M50 85 l20 0 l0 -50 l-20 0 Z" stroke="white" stroke-width="1" fill="white"></path>
        <svg-line :position="{x: 60, y: 80}" :length="40" direction="up" :arrow="true"></svg-line>
      </g>
      <g id="line-right" draggable="true" @dragstart="dragStart($event, 'line-right')" @click="select('line-right')">
      ...
      <g id="line-down" draggable="true" @dragstart="dragStart($event, 'line-down')" @click="select('line-down')">
      ...
      <g id="line-left" draggable="true" @dragstart="dragStart($event, 'line-left')" @click="select('line-left')">
